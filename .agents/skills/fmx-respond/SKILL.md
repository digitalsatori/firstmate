...
This skill is the sole owner of the completion-follow-up procedure below; the `agent-only-skills` trigger table declares the load trigger for Relay-linked milestone or terminal wakes, and AGENTS.md §8 reinforces the terminal final-follow-up step before teardown.
